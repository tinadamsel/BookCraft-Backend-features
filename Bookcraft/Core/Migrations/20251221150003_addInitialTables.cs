        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookOutline = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CoverDesignUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    WritingStyleId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_TargetAudiences_TargetAudienceId",
                        column: x => x.TargetAudienceId,
                        principalTable: "TargetAudiences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_WritingStyles_WritingStyleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_TargetAudienceId",
                table: "Books",
